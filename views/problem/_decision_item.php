...
<div class="item-row mt-3">
    <div class="buttons mr-2">
        ...
        ?>
        <?= Html::a('<svg aria-hidden="true" class="svg-icon iconArrowUpLg" width="36" height="36" viewBox="0 0 36 36"><path d="M2 25h32L18 9 2 25Z"></path></svg>',
        ...
        <div class="ml-2"><?=Html::label($decision['evaluation'])?></div>
        <?= Html::a('<svg aria-hidden="true" class="svg-icon iconArrowDownLg" width="36" height="36" viewBox="0 0 36 36"><path d="M2 11h32L18 27 2 11Z"></path></svg>',
            Url::to(['problem/evaluation']), [
                'data-method' => 'POST',
                'class' => "btn btn-link $class",
                'data-params' => [
